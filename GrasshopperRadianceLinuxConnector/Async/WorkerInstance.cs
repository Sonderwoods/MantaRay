...
namespace GrasshopperRadianceLinuxConnector
{
    ...
    /// <summary>
    /// A class that holds the actual compute logic and encapsulates the state it needs. Every <see cref="GH_TemplateAsync"/> needs to have one.
    ...
    public abstract class WorkerInstance
    {
        ...
        /// <summary>
        /// This token is set by the parent <see cref="GH_TemplateAsync"/>. 
        /// </summary>
        public CancellationToken CancellationToken { get; set; }

        /// <summary>
        /// This is set by the parent <see cref="GH_TemplateAsync"/>. You can set it yourself, but it's not really worth it.
        /// </summary>
        ...
        /// <summary>
        /// Write your data setting logic here. <b>Do not call this function directly from this class. It will be invoked by the parent <see cref="GH_TemplateAsync"/> after you've called `Done` in the <see cref="DoWork(Action{string}, Action{string, GH_RuntimeMessageLevel}, Action)"/> function.</b>
        /// </summary>
        /// <param name="DA"></param>
        public abstract void SetData(IGH_DataAccess DA);

        /// <summary>
        /// Write your data collection logic here. <b>Do not call this method directly. It will be invoked by the parent <see cref="GH_TemplateAsync"/>.</b>
        /// </summary>
        /// <param name="DA"></param>
